...
public class Insert {
    ...
    public  void insertKnife(String name,String type,double weight,double cost,double damage,String  typeofknife){
        Statement statement;
        try {
            String query = String.format(Locale.US,"insert into knife(name, type, weight, cost, damage,typeofknife)  values('%s','%s','%f','%f','%f','%s');",name, type, weight, cost, damage,typeofknife);
            statement= this.connection.createStatement();
            statement.executeUpdate(query);
            //System.out.println("Row inserted");
        }catch (Exception e){
    ...
    public  void insertSword(String name,String type,double weight,double cost,double damage,String  typeofblade){
        Statement statement;
        try {
            String query = String.format(Locale.US,"insert into sword(name, type, weight, cost, damage,typeofblade)  values('%s','%s','%f','%f','%f','%s');",name, type, weight, cost, damage,typeofblade);
            statement= this.connection.createStatement();
            statement.executeUpdate(query);
            //System.out.println("Row inserted");
        }catch (Exception e){
    ...
    public  void insertLance(String name,String type,double weight,double cost,double damage,int  lengthoflnace){
        Statement statement;
        try {
            String query = String.format(Locale.US,"insert into lance(name, type, weight, cost, damage,lengthoflance)  values('%s','%s','%f','%f','%f','%d');",name, type, weight, cost, damage,lengthoflnace);
            statement= this.connection.createStatement();
            statement.executeUpdate(query);
            //System.out.println("Row inserted");
        }catch (Exception e){
